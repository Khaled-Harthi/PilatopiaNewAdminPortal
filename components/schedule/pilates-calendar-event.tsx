...
export default function PilatesCalendarEvent({
  event,
  month = false,
  className,
  onClassClick,
}: {
  event: CalendarEventType & { data?: PilatesClass }
  month?: boolean
  className?: string
  ...
  const handleClick = (e: React.MouseEvent) => {
    e.stopPropagation()
    // If we have class data and a callback, use our custom handler
    if (event.data && onClassClick) {
      onClassClick(event.data)
    }
  }
