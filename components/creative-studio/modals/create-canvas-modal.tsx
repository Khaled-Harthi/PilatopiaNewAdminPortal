...
interface CreateCanvasModalProps {
  ...
  onCreateCanvas: (data: { name: string; file?: File }) => Promise<void>;
}
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Start a new creative project. You can add images later or upload one now.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder={`Canvas ${new Date().toLocaleDateString()}`}
            />
          </div>
